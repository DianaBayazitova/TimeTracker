...
public final class Widget extends JButton implements CustomStatusBarWidget, AWTEventListener {
    ...
    private static final Color COLOR_OFF = new JBColor(new Color(255, 0, 0), new Color(244, 100, 100));
    private static final Color COLOR_ON = new JBColor(new Color(42, 240, 45), new Color(44, 183, 50));
